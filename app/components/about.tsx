      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              With over a decade of experience in real estate and construction, we've successfully delivered premium residential and commercial projects that exceed expectations. Our commitment to quality, transparency, and customer satisfaction sets us apart.
            </motion.p>
            ...
            >
              ...
              <div className="flex-1 w-[50%]">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  "Our mission is to create spaces that inspire and endure. Every project is built with integrity, craftsmanship, and a deep commitment to our clients' vision."
                </p>
              </div>
            </motion.div>
