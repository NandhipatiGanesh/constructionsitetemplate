...
export default function Home() {
  ...
  { id: '1', src: 'http://elementortemplates.in/wp-content/uploads/2025/10/upload.jpg', alt: 'Photo 1', title: 'Title 1' },
  { id: '2', src: 'http://elementortemplates.in/wp-content/uploads/2025/10/upload-4-scaled.jpg', alt: 'Photo 2' },
  { id: '3', src: 'http://elementortemplates.in/wp-content/uploads/2025/10/upload-7-scaled.jpg', alt: 'Photo 3' },
...
const myItems = [
  {
    id: '1',
    title: 'Skyline Heights – Luxury High-Rise Apartments',
    description:
...
const testimonials = [
  ...
  return (
   ...
   {/* <WorksSection /> */}
       ...
       <Gallery4 title="Projects" description="Real world examples." items={myItems} />
